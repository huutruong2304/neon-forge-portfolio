...
const HeroSection = ({ profile, socialLinks, highlight }: Props) => {
  return (
    <section className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-16">
      <Reveal className="flex flex-col items-start">
        ...
        <p className="mt-8 text-white/90 max-w-lg text-lg lg:text-xl mb-8 leading-relaxed">{profile.introduction}</p>
